 ...
 */
function sg_render_floating_whatsapp_button() {
	$whatsapp_number  = sg_get_company_info( 'whatsapp' );
	...
	$link       = sg_get_whatsapp_link( $whatsapp_number );
	$label_text = $whatsapp_display ? $whatsapp_display : __( 'Fale conosco', 'sg-juridico' );
	$aria_label = sprintf(
		/* translators: %s: WhatsApp display number */
		esc_html__( 'Conversar no WhatsApp: %s', 'sg-juridico' ),
		$label_text
	);
	?>
	<a href="<?php echo esc_url( $link ); ?>" class="sg-floating-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( $aria_label ); ?>">
		<span class="sg-floating-whatsapp__icon" aria-hidden="true">
		...
		<span class="sg-floating-whatsapp__label"><?php echo esc_html( $label_text ); ?></span>
	</a>
	<?php
}
add_action( 'wp_footer', 'sg_render_floating_whatsapp_button', 20 );
