...
<a
	...
	aria-label="<?php esc_attr_e( 'Falar conosco no WhatsApp', 'sg-juridico' ); ?>"
>
	<span class="floating-whatsapp__icon" aria-hidden="true">
		<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M16.001 2.666c-7.363 0-13.334 5.97-13.334 13.333 0 2.353.619 4.595 1.79 6.585L2.681 29.334l6.924-1.733a13.276 13.276 0 006.396 1.699h.001c7.363 0 13.333-5.97 13.333-13.333S23.364 2.666 16.001 2.666zm6.906 18.876c-.287.805-1.673 1.53-2.312 1.63-.592.094-1.353.135-2.183-.135-.504-.161-1.15-.37-1.986-.722-3.492-1.505-5.765-5-5.94-5.233-.175-.233-1.42-1.894-1.42-3.618 0-1.724.896-2.569 1.213-2.918.287-.317.766-.456 1.206-.456.14 0 .267.007.383.012.335.014.504.033.725.563.287.696.984 2.403 1.068 2.578.084.175.14.37.026.603-.112.233-.168.37-.335.572-.168.203-.354.456-.504.614-.168.168-.343.35-.147.683.196.317.87 1.428 1.86 2.311 1.28 1.14 2.36 1.495 2.685 1.662.335.168.527.14.72-.084.196-.233.826-.964 1.048-1.298.224-.335.469-.28.78-.168.311.112 1.97.929 2.307 1.097.336.168.559.252.64.394.084.14.084.805-.203 1.61z" fill="currentColor"/>
		</svg>
	</span>
	<span class="screen-reader-text"><?php esc_html_e( 'Iniciar conversa no WhatsApp', 'sg-juridico' ); ?></span>
</a>
</div>
